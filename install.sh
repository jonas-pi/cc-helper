...
declare -a MODELS=(
    "qwen2.5:0.5b|400MB|3|超轻量，极速响应，低配优选"
    "qwen2.5:1.5b|1GB|4|轻量快速，中文优秀，日常推荐"
    "qwen2.5:3b|2GB|8|中等性能，准确度高，平衡之选"
    "qwen2.5:7b|4.7GB|16|高性能，128K上下文，专业级"
    "phi3.5|2.2GB|8|微软3.8B模型，代码生成强，128K上下文"
    "llama3.2:1b|1.2GB|4|Meta轻量，多语言，边缘设备优选"
    "llama3.2:3b|2GB|8|Meta平衡，多模态支持，通用性强"
)
